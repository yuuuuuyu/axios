...
// get请求特殊入参
const specialParam = ['responseType']

// 原始 axios.create
const axiosCreate = axios.create

// get请求入参清洗
const removeKeysFromObject = (object, keysArray, config) => {
...
axios.create = (config = {}) => {
    ...
    instance.interceptors.request.use(
        config => {
            // 清洗
            config.method === 'get' && removeKeysFromObject(config.params, specialParam, config)
